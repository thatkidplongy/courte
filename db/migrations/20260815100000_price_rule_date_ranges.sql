...
ALTER TABLE price_rules
  ADD CONSTRAINT price_rules_window_forward
...
-- the meantime.
DROP INDEX IF EXISTS price_rules_court_idx;
...
ALTER TABLE price_rules
  DROP CONSTRAINT IF EXISTS price_rules_window_forward,
  DROP CONSTRAINT IF EXISTS price_rules_valid_range,
