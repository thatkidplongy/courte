...
/**
 * The class strings below are ours to tune even though the file is generated: the design
 * system specifies interaction states directly ("a hover tint and a pressed state one step
 * along the accent ramp"), and a ramp step is not something a single `--primary` token can
 * express. Structure, props and slots stay as shadcn ships them so the file can still be
 * upgraded — only the variant styling is retuned. See CONVENTIONS.md.
 */
