...
const SignInButton = () => (
  ...
  >
    <button
      type="submit"
      className="bg-court-500 text-ink-950 hover:bg-court-400 rounded-full px-5 py-2 text-sm font-semibold transition"
    >
      Sign in
    </button>
  </form>
...
export const Header = async () => {
  ...
  return (
    <header className="bg-ink-950 border-b border-white/5 text-white">
