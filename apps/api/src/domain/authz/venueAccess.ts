...
/**
 * Re-exported rather than redefined: the role set crosses the wire in the dashboard payload,
 * so it is owned by @courte/contract and there is exactly one definition of it.
 */
